...
const elements = {
  playerName1: document.querySelector(".player1 h2"),
  playerName2: document.querySelector(".player2 h2"),
...
const changeTurn = () => {
  if (player1.active) {
    ...
    player2.active = true;
    elements.playerName1.classList.toggle("player-name-active")
    elements.playerName2.classList.toggle("player-name-active")
